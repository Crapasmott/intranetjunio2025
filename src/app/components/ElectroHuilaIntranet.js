...
const ElectroHuilaIntranet = () => {
  ...
  const news = [
    {
      ...
      excerpt: 'ElectroHuila invierte en modernización de la red eléctrica para mejorar el servicio a la comunidad huilense...',
      date: '25 de Mayo, 2025',
      image: '/images/1.jpg',
      category: 'Infraestructura',
      url: 'https://blog.electrohuila.com/infraestructura-neiva'
    },
    {
      title: 'Programa de Sostenibilidad Ambiental',
      excerpt: 'Nuevas iniciativas verdes para reducir el impacto ambiental de nuestras operaciones corporativas...',
      date: '23 de Mayo, 2025',
      image: '/images/2.jpg',
      category: 'Sostenibilidad',
      url: 'https://blog.electrohuila.com/sostenibilidad-ambiental'
    },
    {
      title: 'Capacitación en Seguridad Industrial',
      excerpt: 'Jornada de formación para todo el personal técnico en nuevos protocolos de seguridad laboral...',
      date: '20 de Mayo, 2025',
      image: '/images/3.jpg',
      category: 'Capacitación',
      url: 'https://blog.electrohuila.com/capacitacion-seguridad'
    }
  ];
  ...
  const humanResources = [
    {
      name: 'Calendario de eventos y cumpleaños',
      icon: Calendar,
      url: 'https://eventos.electrohuila.com',
      description: 'Próximos eventos corporativos y celebraciones',
      bgColor: 'bg-gradient-to-br from-green-500 to-teal-500'
    },
    {
      name: 'Bienestar social',
      icon: Heart,
      url: 'https://bienestar.electrohuila.com',
      description: 'Programas de bienestar para empleados',
      bgColor: 'bg-gradient-to-br from-pink-500 to-rose-500'
    },
    {
      name: 'SST novedades',
      icon: Shield,
      url: 'https://sst.electrohuila.com',
      description: 'Seguridad y Salud en el Trabajo',
      bgColor: 'bg-gradient-to-br from-orange-500 to-red-500'
    },
    {
      name: 'Reporte de comunicaciones',
      icon: MessageSquare,
      url: 'https://comunicaciones.electrohuila.com',
      description: 'Comunicados internos y boletines',
  ...
  const eventGallery = [
    {
      id: 1,
      title: 'Inauguración Nueva Subestación',
      date: '15 de Mayo, 2025',
      category: 'Infraestructura',
      image: '/images/g-1.jpg',
      description: 'Inauguración de la nueva subestación eléctrica en el sector norte de Neiva'
    },
    {
      id: 2,
      title: 'Jornada de Capacitación SST',
      date: '10 de Mayo, 2025',
      category: 'Capacitación',
      image: '/images/g-2.jpg',
      description: 'Personal técnico participando en jornada de seguridad y salud en el trabajo'
    },
    {
      id: 3,
      title: 'Mantenimiento Red Eléctrica',
      date: '8 de Mayo, 2025',
      category: 'Mantenimiento',
      image: '/images/g-3.jpg',
      description: 'Trabajos de mantenimiento preventivo en la red de distribución'
    },
    {
      id: 4,
      title: 'Reunión Directiva Mensual',
      date: '5 de Mayo, 2025',
      category: 'Corporativo',
      image: '/images/g-4.jpg',
      description: 'Junta directiva evaluando resultados del primer trimestre'
    },
    {
      id: 5,
      title: 'Campaña Ahorro Energético',
      date: '2 de Mayo, 2025',
      category: 'Sostenibilidad',
      image: '/images/g-5.jpg',
      description: 'Lanzamiento de campaña educativa sobre uso eficiente de la energía'
    },
    {
      id: 6,
      ...
      image: '/images/g-2.jpg',
      description: 'Celebración del Día del Trabajador con todo el equipo ElectroHuila'
    },
    {
      id: 7,
      title: 'Modernización Centro Control',
      date: '28 de Abril, 2025',
      category: 'Tecnología',
      image: '/images/g-5.jpg',
      description: 'Instalación de nuevos sistemas de monitoreo en tiempo real'
    },
    {
      id: 8,
      title: 'Convenio Universidad',
      date: '25 de Abril, 2025',
      category: 'Educación',
      image: '/images/g-1.jpg',
      description: 'Firma de convenio con universidad local para prácticas estudiantiles'
    }
  ];
  ...
  const socialPosts = [
    {
      platform: 'facebook',
      content: 'ElectroHuila moderniza su infraestructura para brindar mejor servicio a la comunidad huilense.',
      likes: 234,
      comments: 12,
      shares: 45,
      time: '2 horas',
    ...
    {
      platform: 'instagram',
      content: 'Nuestro equipo técnico trabajando por la energía del Huila. #EnergíaConPropósito',
      likes: 189,
      comments: 8,
      shares: 23,
      time: '4 horas',
    ...
    {
      platform: 'youtube',
      content: 'Cómo ElectroHuila está transformando el sector energético - Video corporativo',
      likes: 156,
      comments: 24,
      shares: 67,
      time: '1 día',
  ...
  const systemsOfficeCards = [
    {
      ...
      functions: [
        {
          name: 'Videos Tutoriales de la Mesa de Servicio (Nuevo)',
          date: '3 de septiembre de 2021',
          icon: Camera,
          url: 'https://tutoriales.electrohuila.com/mesa-servicio'
        },
        {
          name: 'Nuevo Submenú - Reseña Histórica',
          date: '3 de febrero de 2021',
          icon: BookOpen,
          url: 'https://historia.electrohuila.com'
        },
        {
          name: 'Nuevo Submenú - Políticas',
          date: '3 de febrero de 2021',
          icon: FileText,
          url: 'https://politicas.electrohuila.com'
        },
        {
          name: 'Actualización Sistema SIMAD',
          date: '15 de enero de 2021',
          icon: Database,
          url: 'https://simad.electrohuila.com/updates'
        },
        {
          name: 'Mejoras Mesa de Servicio',
          date: '10 de enero de 2021',
          icon: Headphones,
          url: 'https://mesaservicio.electrohuila.com/updates'
        }
      ]
    },
    {
      ...
      description: 'Centro de descargas de software y documentos',
      functions: [
        {
          name: 'Complemento Office 365',
          icon: Download,
          url: 'https://descargas.electrohuila.com/office365-complemento.exe',
          type: 'Software'
        },
        {
          name: 'Descargar Utilidad SIMAD',
          icon: Download,
          url: 'https://descargas.electrohuila.com/simad-utility.msi',
          type: 'Utilidad'
        },
        {
          name: 'Drivers Impresoras',
          icon: Printer,
          url: 'https://descargas.electrohuila.com/drivers-impresoras.zip',
          type: 'Drivers'
        },
        {
          name: 'Cliente VPN Corporativo',
          icon: Shield,
          url: 'https://descargas.electrohuila.com/vpn-client.exe',
          type: 'Seguridad'
        },
        {
          name: 'Antivirus Corporativo',
          icon: Shield,
          url: 'https://descargas.electrohuila.com/antivirus-setup.exe',
          type: 'Seguridad'
        },
        {
          name: 'Manual de Usuario SIMAD',
          icon: BookOpen,
          url: 'https://descargas.electrohuila.com/manual-simad.pdf',
          type: 'Documentación'
        }
      ]
    },
    {
      ...
      description: 'Documentación y manuales de usuario',
      functions: [
        {
          name: 'Manual y Documentación SIMAD',
          icon: FileText,
          url: 'https://manuales.electrohuila.com/simad-manual.pdf',
          category: 'SIMAD'
        },
        {
          name: 'Manual Mesa de Servicio',
          icon: FileText,
          url: 'https://manuales.electrohuila.com/mesa-servicio.pdf',
          category: 'Mesa de Servicio'
        },
        {
          name: 'Manual SIG - Sistema de Gestión',
          icon: FileText,
          url: 'https://manuales.electrohuila.com/sig-manual.pdf',
          category: 'SIG'
        },
        {
          name: 'Guía de Usuario Office 365',
          icon: FileText,
          url: 'https://manuales.electrohuila.com/office365-guia.pdf',
          category: 'Office 365'
        },
        {
          name: 'Manual de Seguridad Informática',
          icon: Shield,
          url: 'https://manuales.electrohuila.com/seguridad-informatica.pdf',
          category: 'Seguridad'
        },
        {
          name: 'Procedimientos TIC',
          icon: Settings,
          url: 'https://manuales.electrohuila.com/procedimientos-tic.pdf',
    ...
    },
    {
      ...
      description: 'Centro de soporte y asistencia técnica',
      functions: [
        {
          name: 'Mesa de Ayuda TIC',
          icon: Headphones,
          url: 'https://soporte.electrohuila.com/mesa-ayuda',
          status: 'Disponible 24/7'
        },
        {
          name: 'Diagnóstico Remoto',
          icon: Monitor,
          url: 'https://soporte.electrohuila.com/diagnostico',
          status: 'Disponible'
        },
        {
          name: 'Tickets de Soporte',
          icon: FileText,
          url: 'https://soporte.electrohuila.com/tickets',
          status: 'Activo'
        },
        {
          name: 'Chat en Vivo',
          icon: MessageSquare,
          url: 'https://soporte.electrohuila.com/chat',
          status: 'En línea'
        },
        {
    ...
    },
    {
      ...
      description: 'Gestión de inventario tecnológico',
      functions: [
        {
          name: 'Equipos de Cómputo',
          icon: Laptop,
          url: 'https://inventario.electrohuila.com/equipos-computo',
          count: '245 equipos'
        },
        {
          name: 'Servidores',
          icon: Server,
          url: 'https://inventario.electrohuila.com/servidores',
          count: '12 servidores'
        },
        {
          name: 'Equipos de Red',
          icon: Router,
          url: 'https://inventario.electrohuila.com/equipos-red',
          count: '48 dispositivos'
        },
        {
          name: 'Impresoras',
          icon: Printer,
          url: 'https://inventario.electrohuila.com/impresoras',
          count: '32 impresoras'
        },
        {
          name: 'Dispositivos Móviles',
          icon: Smartphone,
          url: 'https://inventario.electrohuila.com/moviles',
          count: '67 dispositivos'
        },
        {
          name: 'Licencias Software',
          icon: Settings,
          url: 'https://inventario.electrohuila.com/licencias',
          count: '156 licencias'
        }
      ]
    },
    {
      id: 'monitoring',
      title: 'Monitoreo y Estadísticas',
      icon: Activity,
      bgColor: 'bg-gradient-to-br from-indigo-500 to-purple-600',
      iconColor: 'text-indigo-600',
      description: 'Monitoreo de sistemas y estadísticas',
      functions: [
        {
          name: 'Estado de Servidores',
          icon: Server,
          url: 'https://monitoreo.electrohuila.com/servidores',
          status: 'Online',
          uptime: '99.8%'
        },
        {
          name: 'Tráfico de Red',
          icon: Wifi,
          url: 'https://monitoreo.electrohuila.com/trafico',
          status: 'Normal',
          usage: '45%'
        },
        {
          name: 'Uso de Aplicaciones',
          icon: BarChart3,
          url: 'https://monitoreo.electrohuila.com/aplicaciones',
          status: 'Monitoreando',
          users: '234 activos'
        },
        {
          ...
          icon: Shield,
          url: 'https://monitoreo.electrohuila.com/seguridad',
          status: 'Protegido',
          threats: '0 amenazas'
        },
        {
          name: 'Backup y Respaldos',
          icon: HardDrive,
          url: 'https://monitoreo.electrohuila.com/backup',
          status: 'Actualizado',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Botón para mostrar notificaciones si están ocultas */}
      {!showNotifications && (
        <button
